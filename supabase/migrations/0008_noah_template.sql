...
alter table public.site_settings
  ...
  svc_eyebrow text default 'WHAT I DO',
  svc_title text default 'Services that drive growth',
  skills_band_title text default 'Skills & Expertise',
  proj_band_title text default 'FEATURED PROJECTS',
  testi_title text default 'What clients are saying',
  testi_sub text default 'Real results. Real relationships.',
  contact_email text default 'hello@akunstok.studio',
