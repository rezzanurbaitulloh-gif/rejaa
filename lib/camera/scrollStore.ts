...
export const SCENE_PROFILES: SceneProfile[] = [
  ...
  { sceneId: "opening-title", at: 0.16, move: "push-in", entry: "landmark punch", hold: "DALAM PROSES", exit: "release to voice", easing: "smoothstep", safeText: "left", pos: [0, 0.1, 7], look: [0, 0, 0], fov: 36, roll: 0, planet: { x: 3.0, y: 0, s: 1.55 } },
  ...
  { sceneId: "transition", at: 0.52, move: "pull-back", entry: "cosmos recedes to point", hold: "DUNIA NYATA", exit: "dive to reality", easing: "smoothstep", safeText: "center", pos: [0, 0, 15], look: [0, 0, 0], fov: 49, planet: { x: 0, y: -3.4, s: 0.5 }, roll: 0.04 },
  ...
  { sceneId: "ending", at: 1.0, move: "pull-back", entry: "return to space", hold: "MASIH DALAM PROSES", exit: "line leaves viewport", easing: "smoothstep", safeText: "center", pos: [0, 0.8, 18], look: [0, 0.3, 0], fov: 50, planet: { x: 0, y: 3.0, s: 1.4 }, roll: -0.02 },
];
