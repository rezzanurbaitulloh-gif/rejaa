...
export function PklChapter() {
  ...
  return (
    <div id="pkl">
      ...
      <CameraWorld id="pkl-intro" label="PKL Intro" durationVh={240}
        moves={[
      ...
      {/* APA ITU PKL — pan */}
      <CameraWorld id="pkl-apa" label="Apa itu PKL" durationVh={200}
        moves={[
      ...
      {pkl.goals.length > 0 && (
        <CameraWorld id="pkl-tujuan" label="Tujuan PKL" durationVh={220}
          moves={[
      ...
      {pkl.rules.length > 0 && (
        <CameraWorld id="pkl-aturan" label="Aturan dan Tanggung Jawab" durationVh={180}
          moves={[
      ...
      <CameraWorld id="pkl-tempat" label="Tempat PKL" durationVh={200}
        moves={[
      ...
      {pkl.people.length > 0 && (
        <CameraWorld id="pkl-people" label="Pimpinan dan Pembimbing" durationVh={220}
          moves={[
      ...
      {pkl.routine.length > 0 && (
        <CameraWorld id="pkl-hari" label="Hari-hari Saya" durationVh={320}
          moves={[
      ...
      {pkl.activities.length > 0 && (
        <CameraWorld id="pkl-aktivitas" label="Aktivitas PKL" durationVh={260}
          moves={[
      ...
      {pkl.challenges.length > 0 && (
        <CameraWorld id="pkl-tantangan" label="Problem ke Solution" durationVh={220}
          moves={[
